...
import { Filter } from '../paginatedDaysOff/paginatedDaysOff'
...
export const FilterModal: FC<props> = (props) => {
    ...
    const handleFilter = () => {
        const dayOffTypeSelected = dayOffTypes.find(
            (d) => d.dayOffType === type.toLowerCase()
        )
        ...
        props.handleFilter({
            type: dayOffTypeSelected ? dayOffTypeSelected.id : 0,
